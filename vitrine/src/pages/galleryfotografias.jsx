...
// Componente GalleryFoto
const GalleryFoto = () => {
  const handleAnimationComplete = () => {
    console.log("Animation completed!");
  };

  // Dados apenas para a categoria Posts
  const galleryItems = [
    {
      id: 7,
    ...
    {
      id: 16,
      title: "Post: Dicas de Design",
      description: "Conteúdo com dicas valiosas sobre design gráfico.",
      category: "Post",
      image: "/src/assets/dicas-design.png",
    },
    {
      id: 17,
      title: "Post: Tendências 2025",
      description: "As principais tendências em design para 2025.",
      category: "Post",
      image: "/src/assets/tendencias-2025.png",
    },
    {
      id: 18,
      title: "Post: Case de Sucesso",
      description: "Apresentação de um case de sucesso em design.",
      category: "Post",
      image: "/src/assets/case-sucesso.png",
    },
  ];
